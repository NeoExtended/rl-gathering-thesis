...
\begin{figure}[htp]
    ...
    \begin{center}
        \includegraphics[clip, width=0.75\columnwidth]{figures/evaluation/rewards/continuous_vs_discrete_ep_len.pdf}
    \end{center}
    
    %\vspace*{-6pt}
    \caption[Training Curves with Curiosity Reward]{(TODO: This is a placeholder. Replace with better examples and averaged/smoothed curve.) Average episode length on the corridor environment.}
