...
\begin{table}
    \begin{center}
        \begin{tabular}{llrrrrrr}
            \toprule
            & & \multicolumn{3}{c}{Avg Ep Len (256 Particles)} & \multicolumn{3}{c}{Avg Ep Len (1000 Particles)} \\
            \cmidrule(lr){3-5} \cmidrule(lr){6-8} 
            \multicolumn{1}{c}{Instance} & \multicolumn{1}{c}{Algorithm} & \multicolumn{1}{c}{Alg} & \multicolumn{1}{c}{RL} & \multicolumn{1}{c}{Difference} & \multicolumn{1}{c}{Alg} & \multicolumn{1}{c}{RL} & \multicolumn{1}{c}{Difference} \\
            \midrule
            \multirow{4}{*}{Corridor} & ssp & & \multirow{4}{*}{217.53} & & & & \\
            & dsp & & & & & & \\
            & mte & & & & & & \\
            & mtse & 457.98 & & & 477.75 & & \\
            \midrule
            \multirow{4}{*}{Vessel} & ssp & & & & & & \\
            & dsp & & & & & & \\
            & mte & & & & & & \\
            & mtse & & & & & & \\
            \midrule
            \multirow{4}{*}{Capillary} & ssp & & \multirow{4}{*}{381.44} & & & & \\
            & dsp & & & & & & \\
            & mte & & & & & & \\
            & mtse & & & & & & \\
            \midrule
            \multirow{4}{*}{Brain} & ssp & & \multirow{4}{*}{1217.32} & & & & \\
            & dsp & & & & & & \\
            & mte & & & & & & \\
            & mtse & & & & & & \\
            \bottomrule
...
\begin{table}[htp]
    \begin{center}
        \begin{tabular}{rlrrr}
            ...
            2 & Network 1 + SELU & \textbf{73.21} & \textbf{78.03} & 398k \\
            3 & SELU & 146.50 & 155.36 & 428k \\
            4 & SELU again TODO & 130.47 & 135.40 & 402k \\
            5 & Network 1 + SELU + FS 2 & 128.09 & 143.76 & 460k \\
            6 & Network 2 + SELU & 106.75 & 118.45 & \textbf{283k} \\
            \bottomrule
        \end{tabular}
    \end{center}
