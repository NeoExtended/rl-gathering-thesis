...
Looking at Figure \ref{fig:Algorithm/Ep_Length} we can see the average episode length during training. 
Progress during training, explenation for ACKTR curves.
